...
| アドオン                                                             | マイクラ      | 備考                                                                                                            |
| -------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------- |
| [V5.0.0](https://github.com/HakoMC/RoadPackPlus/releases/tag/V5.0.0) | V1.21.110以降 |                                                                                                                 |
...
## 2025/12/03 V5.0.0 Update

### 追加要素

- 側溝の種類を追加。(網・蓋なし)
- 以前のバージョンにあった白線付きブロックを非推奨にし、向いた方向に回転させて設置できる白線付きブロックとハーフブロックを追加。(細い線・太い線・斜めの線・曲がった線)
- 橙線付きブロック・ハーフブロックを追加。(細い線・斜めの線)
- 十字とT字の線の付いたブロック・ハーフブロックを追加。

### 修正

- 特殊ブロックを上や下を見て設置した時に、正しく回転しない問題を修正。(以前のバージョンにあったブロックを非推奨とし、修正したブロックを追加。)
- フォームのMTCとの競合が直っていなかった問題を修正。
- 一部のブロックが燃えてしまう問題を修正。(このアドオンのブロックは全て燃えなくなりました。)

### その他

- Script APIの@minecraft/serverをv2.2.0に更新。
